...
static const char REQUESTSERVICEINFO[] = "rosserial_msgs/RequestServiceInfo";
  ...
  class RequestServiceInfoResponse : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      int offset = 0;
#ifndef ROS_MSG_DONT_SERIALIZE
      uint32_t length_service_md5 = strlen( (const char*) this->service_md5);
      ...
      uint32_t length_request_md5 = strlen( (const char*) this->request_md5);
      ...
      uint32_t length_response_md5 = strlen( (const char*) this->response_md5);
